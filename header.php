...
<body>
    <header class="nav">
        <div class="burger">
            <a class="burger__logo" href="<?php bloginfo("url"); ?>">
            ...
            <a class="button burger__button -gradient" href="<?php bloginfo("url"); ?>/produit/Dynawatch">
        ...
        <a class="nav__logo" href="<?php bloginfo("url"); ?>">
